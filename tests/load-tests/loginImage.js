...
{
    let urlLogin = 'https://informatik.hs-bremerhaven.de/docker-jwaldenmaier-java/api/V1/login'
    let dataLogin = {
    ...
    let urlImage = 'https://informatik.hs-bremerhaven.de/docker-jwaldenmaier-java/api/V1/hoot/image'
    let dataImage = {
        content: "test123",
    ...
    let resPost = http.post(urlImage, JSON.stringify(dataImage), paramsImage);
